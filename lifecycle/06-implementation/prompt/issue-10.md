...
Before each phase: attach / `#`-reference GitHub issue **#10**.
...
Research only for PulseBoard GitHub issue #10.
Do not write production code. Do not plan or implement yet.

Authoritative scope: https://github.com/AbhranilGit/HVE-Core-Course/issues/10
...
Plan implementation of PulseBoard GitHub issue #10 only.
...
Implement the approved plan for PulseBoard GitHub issue #10 only.
