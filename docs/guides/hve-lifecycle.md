...
| | |
| --- | --- |
| **Input** | MVP framing (problem + in/out of scope), e.g. `docs/project-planning/mvp-framing.md` |
| **Output** | `docs/project-planning/brd.md` — problem, users, success, scope, open questions |
| **Helper** | **`brd-builder`** |
...
| | |
| --- | --- |
| **Input** | `docs/project-planning/prd.md` |
...
4. Trusting chat history instead of files in `docs/project-planning/` and `.copilot-tracking/`.
